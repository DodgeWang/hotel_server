			...
			function(result){
               ...
               setTimeout(function(){
                      ...
                      for(var i = 0; i < dataList.length; i++){
                         ...
                         var isCheckDom = '';
                         var isCleanDom = '';
                         if(itermDate.isCheck == 1){
                            isCheckDom = '<button type="button" class="btn btn-success btn-xs">YES</button>'
                         }else{
                            isCheckDom = '<button type="button" class="btn btn-danger btn-xs">NO</button>'
                         }

                         if(itermDate.isClean == 1){
                            isCleanDom = '<button type="button" class="btn btn-success btn-xs">YES</button>'
                         }else{
                            isCleanDom = '<button type="button" class="btn btn-danger btn-xs">NO</button>'
                         }
